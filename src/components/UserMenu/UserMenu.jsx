  ...
  return (
    <div className="user-menu">
      ...
      <div className="user-menu__content">
        <img src="https://api.iconify.design/bxs/user-circle.svg?color=white"className="user-menu__profile" alt="User profile" />
        <h2 className="user-menu__title"> User Login</h2>
        <form className="user-menu__form" onSubmit={handleSubmit}> 
          <label for="first_name" className="user-menu__form--label"> First name: </label>
